...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case mine:
      handleMine(choice1, choice2, handPos, currentPlayer, state);
    ...
    case baron:
      handleBaron(choice1, currentPlayer, state);
    ...
    case tribute:
      handleTribute(currentPlayer, nextPlayer, state, tributeRevealedCards);

    case ambassador:
      handleAmbassador(choice1, choice2, handPos, currentPlayer, state);
...
int processEstate(int currentPlayer, struct gameState* state, int p) {
...
int discardAndDrawFour(int handPos, int i, struct gameState* state) {
